...
public class Eisagwgi extends JFrame {
	...
	public Eisagwgi() {
		...
		JButton button = new JButton("\u03A6\u03CD\u03BB\u03B1\u03BE\u03B7");
		sl_contentPane.putConstraint(SpringLayout.SOUTH, button, -10, SpringLayout.SOUTH, contentPane);
		sl_contentPane.putConstraint(SpringLayout.EAST, button, -59, SpringLayout.EAST, contentPane);
		contentPane.add(button);
		
		JButton button_1 = new JButton("\u0391\u03BA\u03CD\u03C1\u03C9\u03C3\u03B7");
		sl_contentPane.putConstraint(SpringLayout.WEST, button_1, 0, SpringLayout.WEST, label_3);
