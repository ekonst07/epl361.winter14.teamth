...
public class anazitisi_me_thesi {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					anazitisi_me_thesi window = new anazitisi_me_thesi();
	...
	private void initialize() {
		...
		JLabel label = new JLabel("\u0395\u0399\u03A3\u0391\u0393\u03A9\u0393\u0397 \u0398\u0395\u03A3\u0397\u03A3 \u039A\u0399\u0392\u03A9\u03A4\u0399\u039F\u03A5:");
