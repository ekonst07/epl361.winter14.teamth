...
public class search_with_position {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					search_with_position window = new search_with_position();
	...
	private void initialize() {
		...
		frmSearchWithThe.setTitle("SEARCH ACCORDING TO PACKET POSITION");
		...
		JLabel lblInsertThePacket = new JLabel("INSERT THE POSITION OF THE PACKET");
